...
class ApiHelperImpl @Inject constructor(private val apiService: ApiService): ApiHelper {
    override suspend fun getCoinListings(start: Int, limit: Int, sort: String, sortDir: String): ApiResponse<CoinListingsResponse> = apiService.getCoinListings(start, limit, sort, sortDir)
